...
_BROADCASTRANDOMFEATURESETREQUEST = DESCRIPTOR.message_types_by_name['BroadcastRandomFeatureSetRequest']
...
BroadcastRandomFeatureSetRequest = _reflection.GeneratedProtocolMessageType('BroadcastRandomFeatureSetRequest', (_message.Message,), {
  'DESCRIPTOR' : _BROADCASTRANDOMFEATURESETREQUEST,
  '__module__' : 'fet_pb2'
  # @@protoc_insertion_point(class_scope:com.groupseven.fet.BroadcastRandomFeatureSetRequest)
  })
_sym_db.RegisterMessage(BroadcastRandomFeatureSetRequest)
